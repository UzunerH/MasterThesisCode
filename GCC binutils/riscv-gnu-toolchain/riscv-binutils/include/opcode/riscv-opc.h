...
/* NLU Instruction opcode macros.  */
#define MATCH_NLU_NLD_NL    0x7
#define MASK_NLU_NLD        0x7F

#define MATCH_NLU_NLD_L     0xB

#define MATCH_NLU_ANF       0x1B
#define MASK_NLU            0xFFF0707F

#define MATCH_NLU_AES_E     0x101B
#define MATCH_NLU_AES_D     0x201B

#define MATCH_NLU_NMU       0x301B
#define MATCH_NLU_NMA0      0x401B
#define MATCH_NLU_NMA1      0x501B
#define MATCH_NLU_NMA2      0x601B
#define MATCH_NLU_NMA3      0x701B
...
#ifdef DECLARE_INSN
DECLARE_INSN(nldnl, MATCH_NLU_NLD_NL, MASK_NLU_NLD_NL)
DECLARE_INSN(nldl, MATCH_NLU_NLD_L, MASK_NLU_NLD_L)
DECLARE_INSN(nnlanf, MATCH_NLU_ANF, MASK_NLU)
DECLARE_INSN(nnlaese, MATCH_NLU_AES_E, MASK_NLU)
DECLARE_INSN(nnlaesd, MATCH_NLU_AES_D, MASK_NLU)
DECLARE_INSN(nmu, MATCH_NLU_NMU, MASK_NLU)
DECLARE_INSN(nma0, MATCH_NLU_NMA0, MASK_NLU)
DECLARE_INSN(nma1, MATCH_NLU_NMA1, MASK_NLU)
DECLARE_INSN(nma2, MATCH_NLU_NMA2, MASK_NLU)
DECLARE_INSN(nma3, MATCH_NLU_NMA3, MASK_NLU)
