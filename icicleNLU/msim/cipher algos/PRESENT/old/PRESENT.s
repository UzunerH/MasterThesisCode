...
SboxTable:
	...
	.type	main, @function
main:
    # PRESENT cipher with RVi32 only
    ...
    li     s8,  0xE72C46C0      # s8 = expected output state 63...32
    li     s9,  0xF5945049      # s9 = expected output state 31...0
...
round:
    ...
    # shift key
    # newk1 = (key3<<13) >> 16 , alternatively: (key3>>3)[15:0]
    # newk2 = key2 >> 19 + key1<<13 + key3<<29
    # newk3 = key3>>19 + key2<<13
